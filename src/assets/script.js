...
$(function() {
  var pivotGridChart = $("#pivotgrid-chart").dxChart({
      ...
      onFileSaving: function(e){
        exportGridWithChart(pivotGrid, e.data);
        e.cancel = true;
      }
  }).dxChart("instance");
  ...
  var pivotGrid = $("#pivotgrid").dxPivotGrid({
      ...
      onExporting: function(e) {
        pivotGridChart.exportTo('chart', 'PNG');
        e.cancel = true;
      },
      dataSource: {
          fields: [{
  ...
  function exportGridWithChart(grid, chartImage) {
    var workbook = new ExcelJS.Workbook();
    var gridSheet = workbook.addWorksheet('Sales grid');
    var chartSheet = workbook.addWorksheet('Sales chart');
    ...
    DevExpress.excelExporter.exportPivotGrid({
      ...
      chartSheet.addImage(image,'A1:L16');
    }).then(function() {
